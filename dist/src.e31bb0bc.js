...
function Node() {
  ...
  var xPos = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 10;
  var yPos = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 10;
...
var gridDatastore = gridData();
var grid = d3.select("#grid").append("svg").attr("width", "".concat(window.innerWidth, "px")).attr("height", "".concat(window.innerHeight, "px"));
var row = grid.selectAll(".row").data(gridDatastore).enter().append("g").attr("class", "row");
