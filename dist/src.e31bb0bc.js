...
module.exports = function GridData() {
  ...
  var rows = 32;
  var columns = 32;
  var width = window.innerWidth / columns;
  var height = width; // TODO: get cell width to round up if theres leftover width
...
module.exports = function Node(gridData) {
  var _this = this;

  var xPos = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 10;
  var yPos = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 10;
  ...
  this.peek = function (x, y) {
    if (_this.xPos - 1 < x || x < _this.xPos + 1) {
      return null;
    } else {
...
var GridData = require('./GridData');

var Node = require('./Node');

var gridDatastore = GridData(); // Create the elements

var gridMap = d3.select("#grid").append("svg").attr("width", "".concat(window.innerWidth, "px")).attr("height", "".concat(window.innerHeight, "px")); // Add the rows

var row = gridMap.selectAll(".row").data(gridDatastore).enter().append("g").attr("class", "row"); // Add the cells

var column = row.selectAll(".cell").data(function (d) {
  return d;
  ...
  return d.width;
}).style("stroke", "#222").style("fill", "#fff"); // Initialise start and endpoints

var Marker = new Node(rows, columns);
var Goal = new Node(rows, columns);
},{"d3":"../node_modules/d3/index.js","./GridData":"GridData.js","./Node":"Node.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "24972" + '/');
